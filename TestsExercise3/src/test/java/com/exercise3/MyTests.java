...
/*	
  ...
  public void setFirstPrice(String price) {
		MyTests.firstPrice = price; 
	}
	
	public String getFirstPrice() {
		return MyTests.firstPrice; 
	}
	
  @Test 	
  @When("^a - Login with valid credentials$") 
  public void User_Login() throws Exception  {
	  AmazonPage.login();
  }

  @Test
  @And("^b - Search for product Samsung Galaxy S9 64GB$") 
  public void Search_Samsung_Galaxy_S9_64GB() throws Exception {
	  Browser.searchSamsung();
  }

  @Test
  @And("^c - Select first product and save the price$") 
